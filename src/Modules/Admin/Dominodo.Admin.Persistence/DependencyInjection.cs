...
public static class DependencyInjection
{
    ...
    // (dev convenience) without AdminDbContext leaving the assembly — it stays internal. Idempotent:
    // MigrateAsync only runs migrations not yet recorded in __ef_migrations.
    public static async Task MigrateAdminDatabaseAsync(this IServiceProvider services, CancellationToken ct = default)
    {
